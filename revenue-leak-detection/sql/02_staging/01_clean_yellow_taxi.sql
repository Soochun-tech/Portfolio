...
INSERT INTO staging_yellow_taxi (vendorid, pickup_datetime, dropoff_datetime, passenger_count, trip_distance, pulocationid, dolocationid, payment_type, ratecodeid, fare_amount, extra, mta_tax, tip_amount, tolls_amount, improvement_surcharge, congestion_surcharge, airport_fee, total_amount, pickup_date, pickup_hour, trip_duration_min, fare_per_mile, is_airport_pickup, is_airport_dropoff)
WITH in_window AS (
    SELECT *
