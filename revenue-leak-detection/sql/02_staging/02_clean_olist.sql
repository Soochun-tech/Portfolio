...
INSERT INTO staging_olist_orders (order_id, customer_id, order_status, order_purchase_ts, order_approved_ts, order_delivered_carrier_ts, order_delivered_customer_ts, order_estimated_delivery, purchase_date, delivery_delay_days, is_late, days_to_deliver)
SELECT
    order_id,
    customer_id,
    order_status,
...
INSERT INTO staging_olist_order_items (order_id, order_item_id, product_id, seller_id, shipping_limit_date, price, freight_value, item_total)
SELECT
    oi.order_id,
    oi.order_item_id,
    oi.product_id,
...
INSERT INTO staging_olist_payments (order_id, primary_payment_type, payment_total, payment_installments, payment_method_count)
WITH per_order_method AS (
    SELECT
        order_id,
        payment_type,
...
INSERT INTO staging_olist_reviews (order_id, review_id, review_score, review_creation_date, review_answer_ts, has_comment, is_negative, is_positive)
...
INSERT INTO staging_olist_customers (customer_id, customer_unique_id, customer_zip_prefix, customer_city, customer_state)
SELECT
    customer_id,
    customer_unique_id,
